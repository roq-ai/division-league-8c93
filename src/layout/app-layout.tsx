...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiBox, FiShield, FiUserPlus } from 'react-icons/fi';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['league-owner', 'team-owner', 'team-member'];
  ...
  const { data, error, isLoading } = useSWR<LeagueInterface[]>(
    ...
    () => getLeagues({ tenant_id: session?.user?.tenantId }),
  );
  loading = isLoading;
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Tournament', path: '/tournaments', entity: 'tournament', service: AccessServiceEnum.PROJECT, icon: FiBox },
